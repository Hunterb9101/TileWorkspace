			...
			for(int j = 0;j<perlin[i].length;j++){
				...
				case NORMAL:
					if(perlin[i][j] < .25){
						...
						c = Gradient.getColorAtPoint(new Color(52,172,0), new Color(0,96,0),perlin[i][j], .25, .43, 3);
					}
					else if(perlin[i][j] > .4 && perlin[i][j] < .5){
						c = Gradient.getColorAtPoint(new Color(52,128,0), new Color(52,172,0),perlin[i][j], .4, .55, 3);
					}
					else if(perlin[i][j] > .5 && perlin[i][j] < .65){
						c = Gradient.getColorAtPoint(new Color(60,60,60), new Color(52,128,0),perlin[i][j], .5, .65, 1);
					}
					else if(perlin[i][j] > .65 && perlin[i][j] < .75){
						c = Gradient.getColorAtPoint(new Color(140,140,140), new Color(60,60,60),perlin[i][j], .65, .8, 1);
					}
					else if(perlin[i][j] > .75){
						c = Gradient.getColorAtPoint(new Color(210,210,210), new Color(235,235,235),perlin[i][j], .75, 1, 6);
					}
					break;
